...
const QuestionC = () => {
    ...
    const nextPage = () => {
        router.push('/deposit/QuestionD')
    }
    return (
        <>
            <div className="flex items-center h-screen md:px-[10vw] px-5 pt-[8vw] md:pb-[20vw] relative">
                <div className="flex flex-col md:gap-16 gap-6">
                    ...
                    <div className="flex flex-col items-start pl-7 gap-7">
                        ...
                        <button className=" rounded-3xl md:px-12 md:py-3 px-6 py-2 bg-background border-[1px] border-[#FF0083] hover:bg-[#FF0083] md:text-base text-sm " onClick={nextPage}>OK</button>
                    </div>
                </div>
